...
part of 'namoz_vaqtlari_model.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class NamozVaqtModelAdapter extends TypeAdapter<NamozVaqtModel> {
  @override
  final int typeId = 0;

  @override
  NamozVaqtModel read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return NamozVaqtModel(
  ...
  @override
  void write(BinaryWriter writer, NamozVaqtModel obj) {
    writer
      ..writeByte(3)
      ..writeByte(0)
      ..write(obj.code)
  ...
  bool operator ==(Object other) =>
      ...
      other is NamozVaqtModelAdapter &&
...
class ParamsAdapter extends TypeAdapter<Params> {
  ...
  Params read(BinaryReader reader) {
    ...
    return Params(
      ...
      isha: fields[2] as int?,
      maghrib: fields[3] as int?,
      midnight: fields[4] as String?,
    );
  }
