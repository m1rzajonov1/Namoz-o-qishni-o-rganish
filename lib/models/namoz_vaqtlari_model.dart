...
//
//     final namozVaqtModel = namozVaqtModelFromJson(jsonString);

import 'dart:convert';

import 'package:hive_flutter/hive_flutter.dart';
part 'namoz_vaqtlari_model.g.dart';

NamozVaqtModel namozVaqtModelFromJson(String str) =>
    NamozVaqtModel.fromJson(json.decode(str));
...
class NamozVaqtModel {
  ...
  factory NamozVaqtModel.fromJson(Map<String, dynamic> json) => NamozVaqtModel(
        code: json["code"],
        status: json["status"],
