class XuftonNamoziData {
  static int index = 0;

  static List<Map<String, String>> xuftonNamozi = [
    {
      'title': '1.Iqomat takbiri',
      'image': '',
      'text1':
...
Iqomat takbiri aytiladi. Iqomat takbirining lafzlari azonnikiga o'xshaydi, farqi - bunisi tez aytiladi:""",
      'text2': """IQOMAT TAKBIRI -

Allohu akbar, Allohu akbar, Allohu akbar, Allohu akbar.

Ashhadu alla ilaha illalloh, Ashhadu alla ilaha illalloh.

Ashhadu anna Muhammadar rosululloh, Ashhadu anna Muhammadar rosululloh.

Hayya 'alas-solah, hayya' alas-solah,

Hayya 'alal-falah, hayya 'alal-falah. Qod qomatis-solah, qod qomatis-solah Allohu akbar, Allohu akbar,
...
La ilaha illalloh.""",
    ...
    {
      'title': '2.Niyat',
      'image': 'assets/images/namoz/niyat.png',
      'text1':
          """<<Alloh rizoligi uchun, bugungi xufton namozining to'rt rakat farzini o'z vaqtida o'qishni niyat qildim»>, deb ko'ngildan o'tkaziladi.""",
      'text2': """""",
      'text3': """"""
    },
    {
      'title': "3.Takbir",
      'image': 'assets/images/namoz/takbir.png',
      'text1':
          """Iftitoh takbiri: - «Allohu akbar» aytilib namozga kiriladi.""",
      'text2': """""",
      'text3': """""",
    },
    {
      'title': "4. Qiyom",
      'image': 'assets/images/namoz/qiyom.png',
      'text1':
...
A'uzu billahi minash shaytonir rojiym. Bismillahir rohmanir rohiym. Alhamdu lillahi robbil'alamiyn. Ar-rohmanir rohiym. Maliki yavmiddiyn. Iyyaka na'budu va iyyaka nasta'iyn. Ihdinas sirotol mustaqiym. Sirotollaziyna an'amta 'alayhim g'oyril mag'zubi 'alayhim valazzolliyn. (omin)
...
Inna a'toynakal-kavsar. Fa solli lirobbika vanhar. Inna shania'ka huval abtar.
...
Mazmuni: (Ey Muhammad,) ayting: «U- Alloh yagonadir. Alloh behojat, (lekin) hojatbarordir. U tug'magan va tug'ilmagan ham. Shuningdek, Unga teng biror Zot yo'qdir»>.""",
    ...
    {
      'title': "5. Ruku",
      'image': 'assets/images/namoz/ruku.png',
      'text1':
          """Zam sura tugagach, «Allohu akbar», deb ruku qilinadi. Uch marta «Subhana robbiyal 'aziym» deyiladi.""",
      'text2': """""",
      'text3': """""",
    },
    {
      'title': "6.Qavma",
      'image': 'assets/images/namoz/qavma.png',
      'text1':
          """Rukudan «Sami'allohu liman hamidah» deb turiladi, so'ng <<Robbana lakal hamd» deyiladi.""",
      'text2': """""",
      'text3': """""",
    },
    {
      'title': "7.Sajda",
      'image': 'assets/images/namoz/sajda.png',
      'text1':
          """<< Allohu akbar» deb sajda qilinadi. Sajdada uch marta: <<Subhana robbiyal a'la» deyiladi.""",
      'text2': """""",
      'text3': """""",
    },
    {
      'title': "8.Jalsa",
      'image': 'assets/images/namoz/jalsa.png',
      'text1': """<<Allohu akbar»> deb sajdadan bosh ko'tariladi.""",
      'text2': """""",
      'text3': """""",
    },
    {
    ...
    {
      'title': "10. 2-chi rakat. Qiyom",
      'image': 'assets/images/namoz/qiyom.png',
      'text1':
          """<<Allohu akbar>>, deb qiyomga (tikka) turilib. «Bismillahir rohmanir rohiym»dan boshlab, Fotiha surasi va bir zam sura o'qiladi.""",
      'text2': """FOTIHA SURASI -
...
Qul a'uzu birobbil falaq. Min sharri ma xolaq. Va min sharri g'osiqin iza vaqob. Va min sharrin naffasati fil 'ugod. Va min sharri hasidin iza hasad.
...
Qul a'uzu birrobin-nas. Malikin-nas. Ilahin-nas. Min sharril vasvasil xonnas. Allaziy yuvasvisu fiy sudurin-nas. Minal jinnati van-nas.
...
Mazmuni: <<(Ey Muhammad,) ayting: "Panoh tilab iltijo qilurman odamlar Parvardigoriga, odamlar Podshohiga, odamlar Ilohiga yashirin vasvasachi (shayton) yovuzligidanki, (u) odamlarning dillariga vasvasa solur. (O'zi) jinlar va odamlardandir">>.""",
    ...
    },
    {
      'title': "16.Qa'da",
      'image': 'assets/images/namoz/jalsa.png',
      'text1': """<<Allohu akbar», deb sajdadan bosh ko'tarilib""",
      'text2': """qa'dada o'tiriladi va <<Attahiyat>> o'qiladi:
...
Mazmuni: Mol, badan, til bilan ado etiladigan butun ibodatlar Alloh uchundir. Ey Nabiy! Allohning rahmati va barakoti Sizga bo'lsin. Sizga va solih qullarga Allohning salomi bo'lsin. Iqrormanki, Allohdan o'zga iloh yo'q. Va yana iqrormanki, Muhammad, alayhissalom, Allohning quli va elchisidirlar.""",
    ...
    {
      'title': "17. 3-chi rakat. Qiyom",
      'image': 'assets/images/namoz/qiyom.png',
      'text1':
          """<<Allohu akbar>>, deb qiyomga (tikka) turilib, faqat Fotiha surasi o'qiladi.""",
      'text2': """FOTIHA SURASI -
...
Mazmuni: Allohning dargohidan quvilgan shayton yomonligidan Allohning panohiga qochaman. Mehribon va rahmli Alloh nomi bilan (boshlayman). Hamd olamlar rabbi Allohgakim, (U) mehribon, rahmli va hisob-kitob kuni (Qiyomat)ning egasidir. Sengagina ibodat qilamiz va Sendangina yordam so'raymiz! Bizni shunday to'g'ri yo'lga boshlaginki, (U) Sen in'om (hidoyat) etganlarning (payg'ambarlar, siddiq va shahidlarning) yo'lidir, g'azabga uchragan (Muso qavmidan itoatsizlarining) va adashgan (Iso qavmining «Allohning farzandi bor>> deydigan) larning emas!""",
    ...
    },
    {
      ...
      'text1': """<<Allohu akbar», deb sajdadan bosh ko'tarilib""",
      'text2':
          """qa'dada o'tiriladi va «Attahiyat»>, <«Salovot», va <<Robbana»> duolari o'qiladi:
...
Mazmuni: «Ey Robbimiz, bizga bu dunyoda ham, oxiratda ham yaxshilikni bergin va bizni do'zax olovi azobidan saqlagin>>.""",
    ...
    {
      'title': "30.Salom",
      'image': 'assets/images/namoz/salom.png',
      'text1':
          """O'ng va chap yelkaga qarab: «Assalamu alaykum va rohmatulloh» deb salom berilib namozdan chiqiladi""",
      'text2': """""",
      'text3': """""",
    },
    {
      'title': "Yakun",
      'image': '',
      'text1': """Shu bilan xufton namozining to'rt rakat farzi tugaydi.""",
      'text2':
          """Xufton namozining ikki rakat sunnati bomdod namozining ikki rakat sunnati kabi o'qiladi, faqat niyatda:<<Alloh rizoligi uchun, bugungi xufton namozining ikki rakat sunnatini o'z vaqtida o'qishni niyat qildim>>, deb niyat qilinadi.""",
    },
  ];
  
  static List<Map<String, String>> xuftonNamoziAyol = [
    {
      'title': '1.Niyat',
      'image': 'assets/images/namoz/a_niyat.png',
      'text1':
          """Xufton namozi to'rt rakat farz va ikki rakat sunnatdan iborat bo'lib, jami olti rakat.

Xufton namozining to'rt rakat farzi(Peshin namozining to'rt rakat farzi kabi)
quyidagicha o'qiladi: 

<<Alloh rizoligi uchun Xufton namozining to'rt rakat farzini o'z vaqtida o'qishni niyat qildim»>, deb ko'ngildan o'tkaziladi.""",
      'text2': """""",
      'text3': """"""
    },
    {
      'title': "2.Takbir",
      'image': 'assets/images/namoz/a_takbir.png',
      'text1':
          """Iftitoh takbiri: - «Allohu akbar» aytilib namozga kiriladi.""",
      'text2': """""",
      'text3': """""",
    ...
    {
      'title': "3. Qiyom",
      'image': 'assets/images/namoz/a_qiyom.png',
      'text1':
          """Qo'llar bog'lanadi va Sano duosi, Fotiha surasi va biror zam sura o'qiladi:""",
      'text2': '',
      'text3': """Sano duosi
...
Mazmuni: (Ey Muhammad,) ayting: «U- Alloh yagonadir. Alloh behojat, (lekin) hojatbarordir. U tug'magan va tug'ilmagan ham. Shuningdek, Unga teng biror Zot yo'qdir»>.""",
    ...
    {
      'title': "4. Ruku",
      'image': 'assets/images/namoz/a_ruku.png',
      'text1':
          """Zam sura tugagach, «Allohu akbar», deb ruku qilinadi. Uch marta «Subhana robbiyal 'aziym» deyiladi.""",
      'text2': """""",
      'text3': """""",
    ...
    {
      'title': "5.Qavma",
      'image': 'assets/images/namoz/a_qavma.png',
      'text1':
          """Rukudan «Sami'allohu liman hamidah» deb turiladi, so'ng <<Robbana lakal hamd» deyiladi.""",
      'text2': """""",
      'text3': """""",
    ...
    {
      'title': "6.Sajda",
      'image': 'assets/images/namoz/a_sajda.png',
      'text1':
          """<< Allohu akbar» deb sajda qilinadi. Sajdada uch marta: <<Subhana robbiyal a'la» deyiladi.""",
      'text2': """""",
      'text3': """""",
    ...
    {
      'title': "7.Jalsa",
      'image': 'assets/images/namoz/a_jalsa.png',
      'text1': """<<Allohu akbar»> deb sajdadan bosh ko'tariladi.""",
      'text2': """""",
      'text3': """""",
    },
...
Mazmuni: «Ey Robbimiz, bizga bu dunyoda ham, oxiratda ham yaxshilikni bergin va bizni do'zax olovi azobidan saqlagin>>.""",
    ...
    {
      'title': "29.Salom",
      'image': 'assets/images/namoz/a_salom.png',
      'text1':
          """O'ng va chap yelkaga qarab: «Assalamu alaykum va rohmatulloh» deb salom berilib namozdan chiqiladi""",
      'text2': """""",
      'text3': """""",
