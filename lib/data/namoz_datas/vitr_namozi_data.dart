class VitrNamoziData {
  static int index = 0;

  static List<Map<String, String>> vitrNamozi = [
    {
      'title': '1.Niyat',
...
<<Alloh rizoligi uchun, uch rakatli Vitr vojib namozini o'qishni niyat qildim», deb ko'ngildan o'tkaziladi.""",
      'text2': """""",
      'text3': """"""
    },
    {
...
Mazmuni: (Ey Muhammad,) ayting: «U- Alloh yagonadir. Alloh behojat, (lekin) hojatbarordir. U tug'magan va tug'ilmagan ham. Shuningdek, Unga teng biror Zot yo'qdir»>.""",
    ...
    },
    {
      ...
      'image': 'assets/images/namoz/qiyom.png',
      'text1': """<<Allohu akbar>>, deb qiyomga (tikka) turiladi.

Qiyomda «Bismillahir rohmanir rohiym»dan boshlab, Fotiha surasi va bir zam sura o'qiladi.""",
      'text2': """FOTIHA SURASI -
...
Mazmuni: Mol, badan, til bilan ado etiladigan butun ibodatlar Alloh uchundir. Ey Nabiy! Allohning rahmati va barakoti Sizga bo'lsin. Sizga va solih qullarga Allohning salomi bo'lsin. Iqrormanki, Allohdan o'zga iloh yo'q. Va yana iqrormanki, Muhammad, alayhissalom, Allohning quli va elchisidirlar.""",
    ...
    },
    {
      ...
      'image': 'assets/images/namoz/qiyom.png',
      'text1':
          """<<Allohu akbar>>, deb qiyomga (tikka) turilib, Fotiha surasi va bir zam sura o'qiladi.""",
      'text2': """FOTIHA SURASI -
...
Mazmuni: (Ey Muhammad,) ayting: «U- Alloh yagonadir. Alloh behojat, (lekin) hojatbarordir. U tug'magan va tug'ilmagan ham. Shuningdek, Unga teng biror Zot yo'qdir»>.""",
    },
    {
      'title': "17.Takbir",
      'image': 'assets/images/namoz/takbir.png',
      'text1': """Zam suradan so'ng,«Allohu akbar» deb quloq qoqiladi.""",
      'text2': """""",
      'text3': """""",
    },
    {
      'title': "18.Qiyom",
      'image': 'assets/images/namoz/qiyom.png',
      'text1': """Qo'l qovushtirilib, Qunnut duosi o'qiladi.""",
      'text2': """QUNUT DUOSI -

Allohumma inna nasta'inuka va nastag'firuk. Vanu'minu bika va natavakalu 'alayka va nusniy 'alaykal xoyr. Va nashkuruka va la nakfuruk. Va naxla'u va natruku may yafjuruk.
...
Mazmuni: «Ey Robbimiz, bizga bu dunyoda ham, oxiratda ham yaxshilikni bergin va bizni do'zax olovi azobidan saqlagin>>.""",
    ...
    },
    {
      'title': "Yakun",
      'image': '',
      'text1': """Shu bilan xufton namozidan keyingi Vitr namozi tugaydi.""",
      'text2': """""",
    },
  ];

  static List<Map<String, String>> vitrNamoziAyol = [
    {
      'title': '1.Niyat',
