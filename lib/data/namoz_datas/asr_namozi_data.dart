class AsrNamoziData {
  ...
  static List<Map<String, String>> asrNamozi = [
    {
      'title': '1.Iqomat takbiri',
      'image': '',
      'text1': """Asr namozi to'rt rakat farzdan iborat.

Asr namozi (Peshin namozining to'rt rakat farzi kabi)

quyidagicha o'qiladi: Iqomat takbiri aytiladi. Igomat takbirining lafzlari

azonnikiga o'xshaydi, farqi - bunisi tez aytiladi:""",
...
La ilaha illalloh.""",
    ...
    },
    {
      ...
      'text1':
          """<<Alloh rizoligi uchun asr namozining to'rt rakat farzini o'z vaqtida o'qishni niyat qildim»>, deb ko'ngildan o'tkaziladi.""",
      'text2': """""",
      'text3': """"""
    },
    {
...
Mazmuni: «Ey Robbimiz, bizga bu dunyoda ham, oxiratda ham yaxshilikni bergin va bizni do'zax olovi azobidan saqlagin>>.""",
    ...
    },
    {
      'title': "Yakun",
      'image': '',
      'text1': """Shu bilan 4 rakat farzlik asr namozi tugaydi.""",
      'text2': """""",
    },
  ];

  static List<Map<String, String>> asrNamoziAyol = [
